...
def draw_world_axes(
    ...
    dbg.draw_string(
        end_x, " +X", False, carla.Color(255, 0, 0), float(life_time), persistent
    )
    dbg.draw_string(
        end_y, " +Y", False, carla.Color(0, 255, 0), float(life_time), persistent
    )
    dbg.draw_string(
        end_z, " +Z", False, carla.Color(0, 0, 255), float(life_time), persistent
    )

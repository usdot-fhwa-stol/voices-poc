...
class BehaviorAgent(BasicAgent):
    ...
    def __init__(self, vehicle, behavior='normal', opt_dict={}, map_inst=None, grp_inst=None, manual_speed_limit=None):
        """
        Constructor method.
    ...
    def _update_information(self,manual_speed_limit):
        """

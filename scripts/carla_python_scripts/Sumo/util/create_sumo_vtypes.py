    ...
    if type_id not in CARLA_BLUEPRINTS_SPECS:
        ...
        if number_of_wheels == 2:
            logging.warning(
                ...
                \tUsing default specification for two-wheeled vehicles: %s""",
                type_id,
            ...
            logging.warning(
                """type id %s not mapped to any sumo vtype.
                \tUsing default specification for wheeled vehicles: %s""",
                type_id,
        ...
        logging.info(
            "type id %s mapped to the following specifications: %s",
            type_id,

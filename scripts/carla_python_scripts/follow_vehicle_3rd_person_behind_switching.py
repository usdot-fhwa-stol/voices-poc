...
class World(object):
    ...
    def restart(self, args):
        ...
        follow_vehicle_list = [args.follow_vehicle_1,args.follow_vehicle_2]
        

        if self.player == None:
            follow_vehicle_index = 0
        else:
            follow_vehicle_index = follow_vehicle_list.index(self.player.attributes["role_name"])
            print("follow_vehicle_index1:" + str(follow_vehicle_index))
            if follow_vehicle_index == 0:
                follow_vehicle_index = 1
            elif follow_vehicle_index == 1:
                follow_vehicle_index = 0
            print("follow_vehicle_index2:" + str(follow_vehicle_index))
            


        # if follow_vehicle_index >= len(follow_vehicle_list):
        #     follow_vehicle_index = 0

        print("follow_vehicle_index3:" + str(follow_vehicle_index))

        for vehicle in carlaVehicles:
                currentAttributes = vehicle.attributes
                #if currentAttributes["role_name"] == "CARLA-MANUAL-1":
                if currentAttributes["role_name"] == follow_vehicle_list[follow_vehicle_index]:
            	    self.player = vehicle
        #self.player = carlaVehicles[0]
        #self.player = self.world.get_actors().find(60)
        # Set up the sensors.
...
def main():
    ...
    argparser.add_argument(
        '--follow_vehicle_1',
        default="CARMA-MITRE",
        help='First vehicle to be used for the follow cam (default: "CARLA-MANUAL-1"')
    argparser.add_argument(
        '--follow_vehicle_2',
        default="CARMA-TFHRC-LIVE",
        help='First vehicle to be used for the follow cam (default: "CARLA-MANUAL-1"')

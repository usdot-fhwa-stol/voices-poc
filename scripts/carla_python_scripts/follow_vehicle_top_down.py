...
class CameraManager(object):
    def __init__(self, parent_actor, gamma_correction, args):
        ...
        self._camera_transforms = [
            ...
            (carla.Transform(carla.Location(x=0, z=40.0), carla.Rotation(pitch=-90.0,yaw=90)), Attachment.Rigid)
            #(carla.Transform(carla.Location(x=-1, y=-bound_y, z=0.5)), Attachment.Rigid)
            #(carla.Transform(carla.Location(x=0, y=2, z=0),carla.Rotation(pitch=270.0)),Attachment.Rigid)
            ]
...
def main():
    ...
    argparser.add_argument(
        '--follow_vehicle',
        default="CARLA-MANUAL-1",
        help='Vehicle to be used for the follow cam (default: "CARLA-MANUAL-1"')

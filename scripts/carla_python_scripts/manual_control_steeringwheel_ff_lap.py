...
class HUD(object):
    ...
    def tick(self, world, clock):
        ...
        if ((t.location.x >= 17.8) and (t.location.x <= 19) and (t.location.y <= -412) and (t.location.y >= -419) ):
...
def game_loop(args):
    ...
    try:
        ...
        debug.draw_line(stop_bar_north,stop_bar_south,0.3,carla.Color(r=255,g=0,b=0),int(0))

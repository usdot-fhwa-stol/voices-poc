...
def main():
    ...
    try:
        ...
        two_box_zone_1 = carla.BoundingBox(
            two_box_zone_center_1, carla.Vector3D(13, 2, 0)
        )
        two_box_zone_2 = carla.BoundingBox(
            two_box_zone_center_2, carla.Vector3D(13, 2, 0)
        )

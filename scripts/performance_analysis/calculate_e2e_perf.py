        ...
        for current_eq in data_to_search_params[J2735_message_type_name]["skip_if_eqs"]:
            ...
            if current_eq["round"]:
                    ...
                    try:
                        ...
                        logging.debug("Unable to round: " + search_packet_eq_value)
                    
                    try:
                        eq_param_value = round(float(eq_param_value),current_eq["round_decimals"])
                    except:
                        logging.debug("Unable to round: " + eq_param_value )
...
def load_data_user_input():
    ...
    while still_loading_data == True:
        ...
        try:
            available_dataset_list = glob.glob("./data/" + J2735_message_type_name + "/*")
        except:
            print("[!!!] No data found at " + "./data/" + J2735_message_type_name)
...
# v2x_to_virtual_clock_skew = 0.043712
# v2x_to_second_clock_skew = -0.213336
# v2x_to_third_clock_skew = -0.000990

# virt_to_v2x_clock_skew = -0.0446525
# virt_to_second_clock_skew = -0.044850


# sv_to_v2x_clock_skew = live_to_nist_clock_skew - (virtual_to_nist_clock_skew + v2x_to_virtual_clock_skew)
# sv_to_dest_clock_skew =  live_to_nist_clock_skew -(virtual_to_nist_clock_skew + v2x_to_virtual_clock_skew - v2x_to_second_clock_skew)

# sv_to_v2x_clock_skew = -live_to_nist_clock_skew + virtual_to_nist_clock_skew + virt_to_v2x_clock_skew
# sv_to_dest_clock_skew = -live_to_nist_clock_skew + virtual_to_nist_clock_skew + virt_to_second_clock_skew

# logging.debug("sv_to_v2x_clock_skew: " + str(live_to_v2x_clock_skew))
# logging.debug("sv_to_dest_clock_skew: " + str(live_to_second_clock_skew))
...
while all_datasets_have_offset == False and packets_to_skip < 30:

...
$localadapterPath/bin/tena-traffic-light-entity-generator $useBestEffort -emEndpoints $VUG_EM_ADDRESS:$VUG_EM_PORT -listenEndpoints $VUG_LOCAL_ADDRESS -intersectionID $VUG_INTERSECTION_ID -verbosity $adapterVerbosity | tee -a $adapterLogFile

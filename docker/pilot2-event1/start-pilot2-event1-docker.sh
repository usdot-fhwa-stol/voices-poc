...
$docker_compose_cmd -f pilot2-event1_docker-compose.yml down
...
$docker_compose_cmd -f pilot2-event1_docker-compose.yml pull

$docker_compose_cmd -f pilot2-event1_docker-compose.yml up
